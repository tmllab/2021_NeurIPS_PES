...
parser.add_argument('--warmup', default='30', type=int, help='default 20')
...
parser.add_argument('--refine_times_1', default=5, type=int, help='default 5')
...
def MixMatch_train(epoch, net, optimizer, labeled_trainloader, unlabeled_trainloader, class_weights):
    ...
    for batch_idx in range(num_iter):
        ...
        loss = Lx + linear_rampup(epoch + batch_idx / num_iter, args.warmup) * Lu
