...
parser.add_argument('--T1', default=3, type=int)
...
scheduler1 = MultiStepLR(optimizer1, milestones=[args.T1 * args.num_iters_epoch, (args.T1 + 1) * args.num_iters_epoch], gamma=0.1)
...
scheduler2 = MultiStepLR(optimizer2, milestones=[args.T1 * args.num_iters_epoch, (args.T1 + 1) * args.num_iters_epoch], gamma=0.1)
...
for epoch in range(args.num_epochs):
    ...
    for iter_index in range(args.num_iters_epoch):
        train(model1, train_iter1, ceriation1, optimizer1, args.num_iters_epoch)
...
if args.num_networks == 2:
    ...
    for epoch in range(args.num_epochs):
        ...
        for iter_index in range(args.num_iters_epoch):
            train(model2, train_iter2, ceriation2, optimizer2, args.num_iters_epoch)
